...
#define DEFAULT_MACHINE_NAME    "ME3D"
#define DEFAULT_SOURCE_CODE_URL "https://github.com/Me3D"
#define BOARD_NAME              "ME3D"


// reaining pins to define 
#define SDPOWER            -1
...
//
#define X_MIN_PIN          3
#define X_MAX_PIN          2//32// 2
#define Y_MIN_PIN          14//42//14
#define Y_MAX_PIN          15//43//15
#define Z_MIN_PIN          18//39//18
#define Z_MAX_PIN          19//40//19

//
// Alternate Z Probe (when not Z_MIN_PIN)
//
...
#define TEMP_1_PIN          15   // 14//
#define TEMP_BED_PIN       14  //15// 14   
